...
namespace Academy.Apis.UI.WinClient
{
    public partial class Form1 : Form
    {
        ...
        {
            UserAdminProxy.UserAdmin _userAdminProxy = new UserAdminProxy.UserAdmin();

            UserAdminProxy.UserDO _userInfo = new UserAdminProxy.UserDO()
            {
            ...
            try
            {
                ...
                UserAdminProxy.OperationResultOfInt32 _opResult =
